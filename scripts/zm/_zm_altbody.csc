...
/*
	...
	Flags: Linked
*/
function init(name, trigger_name, trigger_hint, visionset_name, visionset_priority, enter_callback, exit_callback, var_438dff29, var_55e012f5)
{
...
function function_da02d223(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump)
{
	...
	if(newval == 1)
	{
		callback = level.var_7c3c2334[level.altbody_name];
		if(isdefined(callback))
		{
			self [[callback]](localclientnum);
		}
	...
	{
		callback = level.var_780a9f20[level.altbody_name];
		if(isdefined(callback))
		{
			self [[callback]](localclientnum);
		}
