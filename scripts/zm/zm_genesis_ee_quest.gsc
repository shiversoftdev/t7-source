...
function function_3c2e817d()
{
	...
	foreach(var_56a87db, var_7387f97 in level.var_753f10ae)
	{
...
{
	foreach(var_f0b78e47, var_dda74d31 in var_be748f8)
	{
...
function function_be26578d(var_f5e9fb6c)
{
	...
	foreach(var_2812fa03, var_4d544c7f in var_3a557c26)
	{
...
function function_37acb884(var_f5e9fb6c)
{
	...
	var_7b352087 = struct::get("acm_reel", "targetname");
	if(isdefined(level.var_d29b5881))
	{
		var_7b352087.origin = level.var_d29b5881;
	}
	var_7b352087 thread function_bde2ec4(var_f5e9fb6c);
}
...
function function_5516baeb(b_valid_poi)
{
	...
	{
		foreach(var_9f84532c, var_d72f41af in level.var_4bf2a542)
		{
...
function function_21bfe3c8(var_f5e9fb6c)
{
	...
	level.var_3848ad63 = function_4e44f01(var_7b352087.origin, 1);
	...
	var_7b352087.origin = level.var_3848ad63;
	var_7b352087 thread function_bde2ec4(var_f5e9fb6c);
}
...
function function_24240140()
{
	...
	while(true)
	{
		...
		{
			var_2826b50 = zm_weapons::is_weapon_upgraded(w_weapon);
			if(var_2826b50)
			{
				break;
			}
...
function function_9449053f()
{
	...
	foreach(var_31fe46b, player in level.players)
	{
...
function function_ab34209c()
{
	...
	while(true)
	{
		...
		if(isdefined(nd_current))
		{
			while(b_pause)
			{
				foreach(var_911972a9, e_player in level.activeplayers)
				{
...
/*
	...
	Flags: Linked
*/
function function_e483fde2(var_7249a1d)
{
	/#
	...
	if(isdefined(var_7249a1d) && var_7249a1d)
	{
		level.var_a090a655 setmodel("p7_zm_gen_dark_arena_sphere_metal");
		level.var_a090a655 clientfield::set("sophia_eye_on", 1);
...
function function_b87c7e9a()
{
	while(!level flag::get("sophia_at_teleporter"))
	{
		...
		foreach(var_8a5f13ad, ai_zombie in var_20a550ba)
		{
...
function function_d3e3222b()
{
	...
	for(i = 0; i < var_a29f8103.size; i++)
	{
		...
		foreach(var_c40cb0d9, var_8b87b28 in var_63727ec8)
		{
	...
	foreach(var_29073582, e_player in level.activeplayers)
	{
...
function function_54e04357()
{
	...
	foreach(var_35e14682, e_player in level.activeplayers)
	{
...
function function_27b96bc()
{
	...
	while(level.var_6e907685.size)
	{
		...
		{
			foreach(var_8633ddfb, var_f03dd5b1 in level.var_6e907685)
			{
...
function ee_ending()
{
	...
	foreach(var_1e55e293, player in level.players)
	{
	...
	foreach(var_78546f76, e_player in level.players)
	{
...
{
	foreach(var_b2020ca2, e_object in a_ents)
	{
...
{
	foreach(var_498f02a4, e_player in level.activeplayers)
	{
		if(var_a5efd39d)
		{
...
function function_5db6ba34(var_1a60ad71 = 1)
{
	...
	var_6b1085eb = [];
	foreach(var_3ddfc6e5, ai_zombie in a_ai_zombies)
	{
	...
	foreach(var_7c8e3322, ai_mechz in var_c94c86a8)
	{
		var_63b71acf = 0;
...
function function_14d67389(n_val)
{
	/#
		...
		if(n_val >= 2)
		{
			...
			level flag::set("");
			level flag::set("");
			foreach(var_f3e6755, e_player in level.activeplayers)
			{
...
function function_2e1bc559(n_val)
{
	/#
		...
		foreach(var_a3d5304b, var_c5653cf3 in var_2efcd138)
		{
