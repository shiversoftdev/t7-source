...
function function_8d6e71cf()
{
	...
	foreach(var_c237ba29, e_player in level.activeplayers)
	{
...
function function_af4b355b()
{
	...
	foreach(var_6af134dd, var_beb54dbd in level.var_57f8b6c5)
	{
	...
	do
	{
		foreach(var_eb6f2fcb, var_beb54dbd in level.var_57f8b6c5)
		{
...
{
	foreach(var_7cb4d6bd, var_beb54dbd in level.var_57f8b6c5)
	{
...
{
	foreach(var_265afef0, var_beb54dbd in level.var_57f8b6c5)
	{
...
function function_72d1d0bb()
{
	...
	foreach(var_58ed7049, var_a6de34cb in var_4ace0f6b)
	{
...
function function_96953619()
{
	...
	do
	{
		foreach(var_d36fd8b2, var_82fe6472 in level.var_4c56821d)
		{
...
{
	foreach(var_9d93248, var_82fe6472 in level.var_4c56821d)
	{
...
{
	var_2200eb08 = struct::get("ee_sophia_struct", "targetname");
	foreach(var_78f4582d, var_82fe6472 in level.var_4c56821d)
	{
	...
	foreach(var_821b1225, var_82fe6472 in level.var_4c56821d)
	{
		var_82fe6472 delete();
		util::wait_network_frame();
	}
...
function function_b96348ee()
{
	...
	while(true)
	{
		...
		{
			var_723ad688 = struct::get("ee_keys_pod_struct", "targetname");
			mdl_piece = util::spawn_model("p7_zm_sta_wall_map_figure_06_pod", var_723ad688.origin + vectorscale((0, 1, 0), 20), var_723ad688.angles);
...
function function_35eed524()
{
	...
	self endon(#"death");
	var_ba7df677 = struct::get("ee_keys_pipe", "targetname");
	if(1)
	{
		for(;;)
		{
			...
			var_cb78916d = var_ba7df677.origin;
...
function function_71e9014a()
{
	...
	var_723ad688 = struct::get("ee_keys_935_struct", "targetname");
	mdl_piece = util::spawn_model("p7_zm_sta_wall_map_figure_05_symbol", var_723ad688.origin, var_723ad688.angles);
...
function function_87bac664()
{
	while(true)
	{
		...
		if(str_exploder == "fxexp_200")
		{
			...
			var_4a6273cc delete();
			var_723ad688 = struct::get("ee_keys_raz_struct", "targetname");
			mdl_piece = util::spawn_model("p7_zm_sta_wall_map_figure_03_soldier", var_723ad688.origin + vectorscale((0, 0, -1), 32), var_723ad688.angles);
			mdl_piece clientfield::set("ee_safe_smash_rumble", 1);
			mdl_piece playsound("zmb_keyskeyskeys_safe_explode");
			e_player = var_723ad688 function_6e3a6092();
...
function function_469f74c5()
{
	...
	while(true)
	{
		...
		if(level.var_ab1ca2f9.size)
		{
			...
			level.var_ab1ca2f9 = [];
			foreach(var_e2f3ff6f, var_66fe5441 in var_6d30388)
			{
...
function function_5fa7e851()
{
	...
	for(i = 0; i < 2; i++)
	{
		foreach(var_594566d3, var_5bc265e5 in var_1f19614)
		{
...
function function_b09a54a3()
{
	...
	foreach(var_9a643c30, s_location in var_8f0097a0)
	{
	...
	foreach(var_e1690e, e_volume in var_2e36b699)
	{
		str_location = e_volume.script_string;
		foreach(var_68d77f6a, s_location in var_8f0097a0)
		{
	...
	foreach(var_9349105d, s_attack_point in var_c746b61a)
	{
		str_location = s_attack_point.script_string;
		level.var_583e4a97.var_4dfc9f38[str_location].var_b454101b = s_attack_point;
	}
	foreach(var_7cf1da9, var_3d8a9064 in level.var_583e4a97.var_4dfc9f38)
	{
...
function function_4da4c438()
{
	...
	foreach(var_a51831d9, var_e782bc88 in var_f54e06c3)
	{
		var_e782bc88 delete();
		util::wait_network_frame();
	}
...
function function_f5139aae()
{
	...
	#/
	var_6ea4ef96 = struct::get("ee_escort_spawn", "targetname");
	if(level zm_ai_sentinel_drone::function_19d0b055(1, &function_de888a13, 1, var_6ea4ef96))
	{
...
function function_62f0a233()
{
	...
	foreach(var_3e669e3d, var_1fc5be4a in var_8338c325)
	{
...
function function_ceeaf112()
{
	...
	while(true)
	{
		...
		if(e_who == self)
		{
			...
			self ai::set_ignoreall(1);
			var_f80d6608 delete();
			var_55471a18 = struct::get("ee_capture_point", "targetname");
			self setgoal(var_55471a18.origin);
			var_c1fbdc10 = util::spawn_model("tag_origin", var_55471a18.origin);
			self notsolid();
			self waittill(#"goal");
			wait(0.5);
...
function function_6a1cc377()
{
	...
	foreach(var_e2300976, mdl_button in var_7953b28)
	{
	...
	wait(1);
	foreach(var_8695a84b, mdl_button in var_7953b28)
	{
...
function function_18375f27(var_4af7b97)
{
	...
	{
		wait(0.4);
		foreach(var_c9e18e6a, str_location in var_4af7b97)
		{
		...
		wait(0.4);
		foreach(var_ff45336d, str_location in var_4af7b97)
		{
			str_tag = "tag_map_screen_glow_" + str_location;
	...
	foreach(var_ccdd201d, var_796743e2 in var_bf616d4d)
	{
	...
	foreach(var_7448345b, str_location in var_4af7b97)
	{
		str_tag = "tag_map_screen_glow_" + str_location;
		wait(0.3);
		var_cf5f1519 showpart(str_tag);
	...
	for(i = 0; i < 4 - 1; i++)
	{
		foreach(var_1fedf865, str_location in var_4af7b97)
		{
			str_tag = "tag_map_screen_glow_" + str_location;
			var_cf5f1519 showpart(str_tag);
		}
		level.var_f0d11538 playsound("zmb_scenarios_map_beep_higher");
		wait(0.4);
		foreach(var_6e718b48, str_location in var_4af7b97)
		{
			str_tag = "tag_map_screen_glow_" + str_location;
			var_cf5f1519 hidepart(str_tag);
		}
...
function function_f715c0b9(var_7953b28)
{
	...
	foreach(var_464e2676, mdl_button in var_7953b28)
	{
		mdl_button clientfield::increment("ee_timed_explosion_rumble");
		foreach(var_ae443cd2, e_player in level.activeplayers)
		{
	...
	foreach(var_af047db0, e_player in level.players)
	{
...
{
	foreach(var_899579ae, s_position in level.var_7f02c954)
	{
...
function function_48dcad89()
{
	...
	level function_2868b6f4();
	var_55471a18 = struct::get("ee_capture_point", "targetname");
	self moveto(var_55471a18.origin + vectorscale((0, 0, 1), 48), 4, 0.5);
	self waittill(#"movedone");
...
function function_1a5b6f26()
{
	...
	while(true)
	{
		...
		var_cb91e1e5 = 0;
		foreach(var_2383629f, e_player in level.players)
		{
			if(e_player flag::get("ee_koth_terminal_used"))
			{
				var_693be8d4++;
...
{
	foreach(var_35ad4dde, e_player in level.players)
	{
...
function function_d47c68fb()
{
	...
	var_5f255c08 solid();
	var_1a085458 = getentarray("hatch_slick_clip", "targetname");
	foreach(var_472e11ce, var_1a11e11 in var_1a085458)
	{
		var_1a11e11 delete();
		util::wait_network_frame();
	}
		...
		if(var_af81398 function_2b042a95())
		{
			...
			while(var_af81398 function_2b042a95())
			{
				if(gettime() >= n_end_time)
				{
					...
					foreach(var_da683d10, e_player in level.players)
					{
...
{
	foreach(var_66ccceab, e_player in level.players)
	{
...
function function_6adaea27(b_show)
{
	...
	if(!b_show)
	{
		foreach(var_a3d26333, var_a758a79e in level.chests)
		{
			if(var_a758a79e.hidden === 0)
			{
				level.var_4d36bcd5 = var_a758a79e;
...
function function_146501()
{
	...
	wait(1);
	foreach(var_4713f99b, e_player in level.activeplayers)
	{
...
{
	foreach(var_b344bfc3, e_player in level.activeplayers)
	{
		if(var_a5efd39d)
		{
...
/*
	...
	Flags: Linked
*/
function function_c5c5f391(str_location, var_d858aeb5)
{
	/#
		var_afe8026c = struct::get_array("", "");
		foreach(var_91842906, s_pod in var_afe8026c)
		{
			if(s_pod.script_string == str_location && s_pod.script_int == var_d858aeb5)
			{
				return s_pod;
			}
		}
...
function function_3de60ba3(n_value)
{
	/#
		...
		foreach(var_81bf36dd, mdl_button in var_7953b28)
		{
...
{
	/#
		var_55471a18 = struct::get("", "");
		var_663b2442 = zombie_utility::spawn_zombie(level.var_fda4b3f3[0], "", var_55471a18);
		var_663b2442 vehicle_ai::set_state("");
		var_663b2442 sentinel_drone::sentinel_destroyallarms(1);
		var_663b2442.origin = var_55471a18.origin + vectorscale((0, 0, 1), 30);
		wait(1);
...
function function_9b3c25cd(n_value)
{
	/#
		var_55471a18 = struct::get("", "");
		var_1c963231 = zombie_utility::spawn_zombie(level.var_6bca5baa[0], "", var_55471a18);
