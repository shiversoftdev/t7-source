...
private function function_fa29651d(entity)
{
	...
	foreach(var_c46e581, zombie in zombies)
	{
...
private function function_d59056ec(entity)
{
	...
	{
		foreach(var_df9c4f31, octobomb in level.octobombs)
		{
...
private function function_604404(entity)
{
	...
	{
		foreach(var_1c0bd7aa, react in self.react)
		{
			if(react == entity)
			{
				return 1;
...
/*
	...
	Flags: Linked, Private
*/
private function function_6312be59(entity)
{
	...
	{
		foreach(var_110fdfe4, vortex in level.vortex_manager.a_active_vorticies)
		{
...
private function margwa_bodyfall()
{
	...
	{
		var_3bd46762 = [];
		foreach(var_8d36df3c, powerup in level.zombie_powerup_array)
		{
...
{
	players = getplayers();
	foreach(var_fd6910a9, player in players)
	{
	...
	/#
		while(true)
		{
			if(isdefined(self.debughealth) && self.debughealth)
			{
				...
				{
					foreach(var_1181deb1, head in self.head)
					{
						if(head.health > 0)
						{
...
private function function_8d578a58()
{
	...
	foreach(var_319c7e11, player in level.players)
	{
...
private function function_89e37c9b(entity, inflictor, weapon)
{
	...
	{
		foreach(var_33307d3b, head in entity.head)
		{
	...
	if(var_ddc770da.size > 0)
	{
		...
		foreach(var_f58ebfe8, head in var_ddc770da)
		{
...
{
	zombies = zombie_utility::get_round_enemy_array();
	foreach(var_a2b75126, zombie in zombies)
	{
