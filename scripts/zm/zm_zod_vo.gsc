...
{
	foreach(var_cae08306, player in level.activeplayers)
	{
		if(isdefined(player))
		{
...
function vo_clear()
{
	...
	self.isspeaking = 0;
	b_in_a_e_speakers = 0;
	foreach(var_eb0d657b, e_checkme in level.a_e_speakers)
	{
		if(e_checkme == self)
		{
			b_in_a_e_speakers = 1;
...
function function_2426269b(v_pos, n_range = 1000)
{
	...
	{
		foreach(var_ea640538, var_d211180f in level.a_e_speakers)
		{
...
function function_897246e4(str_vo_alias, n_wait = 0, b_wait_if_busy = 0, var_a8564a44 = 0, var_d1295208 = 0)
{
	...
	{
		e_speaker = undefined;
		level function_b2392771(str_vo_alias, n_wait, b_wait_if_busy, var_a8564a44);
	}
	else
	{
		e_speaker = undefined;
...
/*
	...
	Flags: Linked
*/
function function_b2392771(str_dialog, var_853e20ac = 0, b_wait_if_busy, var_a8564a44 = 0)
{
	function_218256bd(1);
...
function function_642e6aef(impact, mod, weapon, zombie, instakill, dist, player)
{
	...
	{
		foreach(var_38dbb726, var_61254add in level.sword_quest.weapons)
		{
			foreach(var_54ccd8b0, var_162382f2 in var_61254add)
			{
...
function function_7884e6b8()
{
	...
	foreach(var_265afef0, dude in level.activeplayers)
	{
...
function function_5a3465d8()
{
	...
	wait(0.5);
	foreach(var_911972a9, e_player in level.players)
	{
...
function function_bcf7d3ea(a_spawners)
{
	...
	{
		foreach(var_f2552a09, x in a_spawners)
		{
...
function function_7a64d508()
{
	...
	var_f3aa6934 = [];
	foreach(var_79600633, plr in level.activeplayers)
	{
		array::add(var_f3aa6934, plr.characterindex);
	}
	var_3352e74 = 0;
	foreach(var_9f62809c, n_index in var_f3aa6934)
	{
...
function function_2cc571f6()
{
	...
	while(true)
	{
		...
		if(isdefined(level.var_95981590))
		{
			...
			{
				wait(0.5);
				foreach(var_e6693102, plr in level.activeplayers)
				{
...
function function_43b03c7f(var_f30428a8)
{
	...
	while(!var_d8dc8b3c)
	{
		...
		i = 0;
		foreach(var_41869e8b, var_4ef2ab6 in var_60852196)
		{
		...
		{
			foreach(var_a22ee33b, var_4ef2ab6 in var_60852196)
			{
