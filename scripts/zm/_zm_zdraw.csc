...
function function_3e630288()
{
	/#
		...
		level.var_9cf5ce57.colors[""] = (1, 0, 0);
		level.var_9cf5ce57.colors[""] = (0, 1, 0);
		level.var_9cf5ce57.colors[""] = (0, 0, 1);
		level.var_9cf5ce57.colors[""] = (1, 1, 0);
		level.var_9cf5ce57.colors[""] = (1, 0.5, 0);
		level.var_9cf5ce57.colors[""] = (0, 1, 1);
		level.var_9cf5ce57.colors[""] = (1, 0, 1);
		level.var_9cf5ce57.colors[""] = (0, 0, 0);
		level.var_9cf5ce57.colors[""] = (1, 1, 1);
		level.var_9cf5ce57.colors[""] = vectorscale((1, 1, 1), 0.75);
		level.var_9cf5ce57.colors[""] = vectorscale((1, 1, 1), 0.1);
		level.var_9cf5ce57.colors[""] = vectorscale((1, 1, 1), 0.2);
		level.var_9cf5ce57.colors[""] = vectorscale((1, 1, 1), 0.3);
		level.var_9cf5ce57.colors[""] = vectorscale((1, 1, 1), 0.4);
		level.var_9cf5ce57.colors[""] = vectorscale((1, 1, 1), 0.5);
		level.var_9cf5ce57.colors[""] = vectorscale((1, 1, 1), 0.6);
		level.var_9cf5ce57.colors[""] = vectorscale((1, 1, 1), 0.7);
		level.var_9cf5ce57.colors[""] = vectorscale((1, 1, 1), 0.8);
		level.var_9cf5ce57.colors[""] = vectorscale((1, 1, 1), 0.9);
		level.var_9cf5ce57.colors[""] = (0.4392157, 0.5019608, 0.5647059);
		level.var_9cf5ce57.colors[""] = (1, 0.7529412, 0.7960784);
		level.var_9cf5ce57.colors[""] = vectorscale((1, 1, 0), 0.5019608);
		level.var_9cf5ce57.colors[""] = (0.5450981, 0.2705882, 0.07450981);
		level.var_9cf5ce57.colors[""] = (1, 1, 1);
	#/
}
...
function function_aa8545fe()
{
	/#
		...
		level.var_9cf5ce57.commands[""] = &function_5ef6cf9b;
		level.var_9cf5ce57.commands[""] = &function_eae4114a;
		level.var_9cf5ce57.commands[""] = &function_f2f3c18e;
		level.var_9cf5ce57.commands[""] = &function_8f04ad79;
		level.var_9cf5ce57.commands[""] = &function_a13efe1c;
		level.var_9cf5ce57.commands[""] = &function_b3b92edc;
		level.var_9cf5ce57.commands[""] = &function_8c2ca616;
		level.var_9cf5ce57.commands[""] = &function_3145e33f;
		level.var_9cf5ce57.commands[""] = &function_f36ec3d2;
		level.var_9cf5ce57.commands[""] = &function_7bdd3089;
		level.var_9cf5ce57.commands[""] = &function_be7cf134;
	#/
}
...
{
	/#
		level.var_9cf5ce57.color = level.var_9cf5ce57.colors[""];
		...
		level.var_9cf5ce57.var_c1953771 = "";
	#/
}
...
function function_4282fd75(var_859cfb21, startat, var_37cd5424)
{
	/#
		...
		{
			if(isdefined(level.var_9cf5ce57.commands[var_859cfb21[startat]]))
			{
				startat = [[level.var_9cf5ce57.commands[var_859cfb21[startat]]]](var_859cfb21, startat + 1);
			}
...
function function_5ef6cf9b(var_859cfb21, startat)
{
	/#
		if(isdefined(var_859cfb21[startat]))
		{
			...
			else if(isdefined(level.var_9cf5ce57.colors[var_859cfb21[startat]]))
			{
				level.var_9cf5ce57.color = level.var_9cf5ce57.colors[var_859cfb21[startat]];
			}
			else
			{
				level.var_9cf5ce57.color = (1, 1, 1);
...
function function_33acda19(var_859cfb21, startat)
{
	/#
		if(isdefined(var_859cfb21[startat]))
		{
			if(function_c0fb9425(var_859cfb21[startat]))
			{
				level.var_9cf5ce57.var_922ae5d = float(var_859cfb21[startat]);
				startat = startat + 1;
			}
		}
		return startat;
...
function function_ce50bae5(var_859cfb21, startat)
{
	/#
		if(isdefined(var_859cfb21[startat]))
		{
			level.var_9cf5ce57.var_c1953771 = var_859cfb21[startat];
			startat = startat + 1;
		}
		return startat;
	#/
