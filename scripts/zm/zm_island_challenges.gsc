...
function function_b7156b15(var_a879fa43)
{
	...
	for(i = 1; i < 4; i++)
	{
		foreach(var_1edd0b54, t_lookat in getentarray("t_lookat_challenge_" + i, "targetname"))
		{
	...
	foreach(var_575757b6, s_challenge in struct::get_array("s_challenge_trigger"))
	{
...
function function_8675d6ed(var_15fa438f)
{
	...
	var_30ff0d6c.trigger = s_altar function_be89930d(var_a879fa43, var_15fa438f);
	...
	if(e_who == self)
	{
		...
		self function_640cd978(var_15fa438f, s_altar, var_c9d33fc4);
...
/*
	...
	Flags: Linked
*/
function function_640cd978(var_15fa438f, s_altar, var_c9d33fc4)
{
	if(var_15fa438f == 1)
	{
...
function function_16ba3a1e(cmd)
{
	/#
		switch(cmd)
		{
			...
			case "":
			{
				foreach(var_5bb4d02d, player in level.players)
				{
					player flag::set("");
			...
			case "":
			{
				foreach(var_8bc8a375, player in level.players)
				{
					player flag::set("");
			...
			case "":
			{
				foreach(var_f0ed8627, player in level.players)
				{
				...
				foreach(var_febab197, player in level.players)
				{
