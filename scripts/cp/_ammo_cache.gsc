...
function __main__()
{
	...
	foreach(var_52c9493f, mdl_ammo_cache in a_mdl_ammo_cache)
	{
		object = new cammocrate();
		[[ object ]]->__constructor();
		ammo_cache = object;
		[[ ammo_cache ]]->init_ammo_cache(mdl_ammo_cache);
	}
	a_s_ammo_cache = struct::get_array("ammo_cache", "script_noteworthy");
	foreach(var_b20650e8, s_ammo_cache in a_s_ammo_cache)
	{
		object = new cammocrate();
		[[ object ]]->__constructor();
		ammo_cache = object;
...
function onuse(e_player)
{
	...
	foreach(var_32d69962, w_weapon in a_w_weapons)
	{
...
function function_2902ab6c(var_60a09143)
{
	...
	{
		var_d3571721 = 0;
		foreach(var_e26d82db, e_player in level.players)
		{
...
*/
private autoexec function cammocrate()
{
	classes.cammocrate[0] = spawnstruct();
	classes.cammocrate[0].__vtable[1911957146] = &cammocrate::function_71f6269a;
	classes.cammocrate[0].__vtable[688040812] = &cammocrate::function_2902ab6c;
	classes.cammocrate[0].__vtable[-412164853] = &cammocrate::function_e76edd0b;
	classes.cammocrate[0].__vtable[1474560529] = &cammocrate::_is_banned_refill_weapon;
	classes.cammocrate[0].__vtable[1015980183] = &cammocrate::onuse;
	classes.cammocrate[0].__vtable[-1537956454] = &cammocrate::onenduse;
	classes.cammocrate[0].__vtable[-808543358] = &cammocrate::onbeginuse;
	classes.cammocrate[0].__vtable[-2101812940] = &cammocrate::spawn_ammo_cache;
	classes.cammocrate[0].__vtable[903676483] = &cammocrate::init_ammo_cache;
	classes.cammocrate[0].__vtable[1606033458] = &cammocrate::__destructor;
	classes.cammocrate[0].__vtable[-1690805083] = &cammocrate::__constructor;
}
