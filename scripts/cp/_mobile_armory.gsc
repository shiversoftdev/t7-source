...
function __main__()
{
	...
	foreach(var_240dc023, mdl_mobile_armory in a_mdl_mobile_armory)
	{
		object = new cmobilearmory();
		[[ object ]]->__constructor();
		mobile_armory = object;
...
function function_ecdbdfeb(e_player)
{
	...
	a_heroweapons = [];
	foreach(var_1abd7134, weapon in a_weaponlist)
	{
	...
	foreach(var_eefd79cb, weapon in a_heroweapons)
	{
		e_player giveweapon(weapon);
	}
	a_weapons = e_player getweaponslist();
	foreach(var_2ba14403, weapon in a_weapons)
	{
...
function function_69cca2a0(var_ab455203)
{
	...
	{
		var_d3571721 = 0;
		foreach(var_18b8e1, e_player in level.players)
		{
...
*/
private autoexec function cmobilearmory()
{
	classes.cmobilearmory[0] = spawnstruct();
	classes.cmobilearmory[0].__vtable[1911957146] = &cmobilearmory::function_71f6269a;
	classes.cmobilearmory[0].__vtable[1775018656] = &cmobilearmory::function_69cca2a0;
	classes.cmobilearmory[0].__vtable[-412164853] = &cmobilearmory::function_e76edd0b;
	classes.cmobilearmory[0].__vtable[1797235935] = &cmobilearmory::function_6b1fa4df;
	classes.cmobilearmory[0].__vtable[-1345086777] = &cmobilearmory::function_afd39ac7;
	classes.cmobilearmory[0].__vtable[1718649641] = &cmobilearmory::function_66708329;
	classes.cmobilearmory[0].__vtable[-321134613] = &cmobilearmory::function_ecdbdfeb;
	classes.cmobilearmory[0].__vtable[1015980183] = &cmobilearmory::onuse;
	classes.cmobilearmory[0].__vtable[-1537956454] = &cmobilearmory::onenduse;
	classes.cmobilearmory[0].__vtable[-808543358] = &cmobilearmory::onbeginuse;
	classes.cmobilearmory[0].__vtable[-1011858071] = &cmobilearmory::init_mobile_armory;
	classes.cmobilearmory[0].__vtable[1606033458] = &cmobilearmory::__destructor;
	classes.cmobilearmory[0].__vtable[-1690805083] = &cmobilearmory::__constructor;
}
