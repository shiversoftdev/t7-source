...
*/
private autoexec function cteamgather()
{
	...
	classes.cteamgather[0].__vtable[1606033458] = &cteamgather::__destructor;
	classes.cteamgather[0].__vtable[-1690805083] = &cteamgather::__constructor;
}
